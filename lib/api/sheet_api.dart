...
class sheet_api {
  static const String URL_len =
      "http://192.168.17.27:5001/assets/len";

  static const String URL_dahana =
      "http://192.168.17.27:5001/assets/dahana";

  static const String URL_DI =
      "http://192.168.17.27:5001/assets/di";

  static const String URL_Pindad =
      "http://192.168.17.27:5001/assets/pindad";

  static const String URL_PAL =
      "http://192.168.17.27:5001/assets/pal";

  static const String URL_news =
      "http://192.168.17.27:5001/news";

  static const String URL_mailbox_in =
      "http://192.168.17.27:5001/mail/in";

  static const String URL_mailbox_out =
      "http://192.168.17.27:5001/mail/out";

  static const String URL_log =
      "http://192.168.17.27:5001/log";

  static const String URL_mesin_len =
      "http://192.168.17.27:5001/kapabilitas/len";

  static const String URL_mesin_dahana =
      "http://192.168.17.27:5001/kapabilitas/dahana";

  static const String URL_mesin_di =
      "http://192.168.17.27:5001/kapabilitas/di";

  static const String URL_mesin_pindad =
      "http://192.168.17.27:5001/kapabilitas/pindad";

  static const String URL_mesin_pal =
      "http://192.168.17.27:5001/kapabilitas/pal";

  static const String URL_addgambar_len =
      "http://192.168.17.27:5001/assets/photo/len";

  static const String URL_addgambar_dahana =
      "http://192.168.17.27:5001/assets/photo/dahana";

  static const String URL_addgambar_di =
      "http://192.168.17.27:5001/assets/photo/di";

  static const String URL_addgambar_pal =
      "http://192.168.17.27:5001/assets/photo/pal";

  static const String URL_addgambar_pindad =
      "http://192.168.17.27:5001/assets/photo/pindad";
  ...
  static Future<http.Response> register(String user,String mail,String jabatan,String pass)async{
    ...
    var url=Uri.parse("http://192.168.17.27:5001/user/requestAccount");
  ...
  static Future<http.Response> tambahdata(
    ...
    var uri = Uri.parse("http://192.168.17.27:5001/assets/"+namaTabel);
