...
class BukaLink_Asset extends StatefulWidget {
  const BukaLink_Asset({Key? key}) : super(key: key);

  @override
  _BukaLink_Asset createState() => _BukaLink_Asset();
}
...
class _BukaLink_Asset extends State<BukaLink_Asset> {
  @override
              ...
              onPressed: () async{
                try {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => link_asset(data: list),
                    ),
                  );
                  setState(() {
                    link=true;
