...
class barChartdahana extends StatefulWidget {
  final List<sheet_chart> data_chart;
  barChartdahana({Key? key, required this.data_chart}) : super(key: key);

  @override
  _barChartdahana createState() => _barChartdahana();
...
class _barChartdahana extends State<barChartdahana> {
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 50),
                Text("Jumlah Data Assets Terpilih: "+widget.data_chart.length.toString()),
              ],
            ),
          ),
          Expanded(
