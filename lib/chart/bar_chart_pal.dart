...
class barChartPAL extends StatefulWidget {
  final List<sheet_chart> data_chart;
  barChartPAL({Key? key, required this.data_chart}) : super(key: key);

  @override
  _barChartPAL createState() => _barChartPAL();
...
class _barChartPAL extends State<barChartPAL> {
