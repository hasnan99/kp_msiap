...
class barChartpindad extends StatefulWidget {
  final List<sheet_chart> data_chart;
  barChartpindad({Key? key, required this.data_chart}) : super(key: key);

  @override
  _barChartpindad createState() => _barChartpindad();
...
class _barChartpindad extends State<barChartpindad> {
