...
class barChartLen extends StatefulWidget {
  final List<sheet_chart> data_chart;
  barChartLen({Key? key, required this.data_chart}) : super(key: key);

  @override
  _barChartLenState createState() => _barChartLenState();
...
class _barChartLenState extends State<barChartLen> {
