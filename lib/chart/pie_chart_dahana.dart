...
class pieChartdahana extends StatefulWidget {
  final List<sheet_chart> data_chart;
  pieChartdahana({Key? key, required this.data_chart}) : super(key: key);

  @override
  _pieChartdahana createState() => _pieChartdahana();
...
class _pieChartdahana extends State<pieChartdahana> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text("Pie Chart Dahana"),
          leading: IconButton(
