...
class pieChartLen extends StatefulWidget {
  final List<sheet_chart> data_chart;
  pieChartLen({Key? key, required this.data_chart}) : super(key: key);

  @override
  _pieChartLen createState() => _pieChartLen();
...
class _pieChartLen extends State<pieChartLen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text("Pie Chart LEN"),
          leading: IconButton(
