...
class pieChartPAL extends StatefulWidget {
  final List<sheet_chart> data_chart;
  pieChartPAL({Key? key, required this.data_chart}) : super(key: key);

  @override
  _pieChartPAL createState() => _pieChartPAL();
...
class _pieChartPAL extends State<pieChartPAL> {
