...
class pieChartpindad extends StatefulWidget {
  final List<sheet_chart> data_chart;
  pieChartpindad({Key? key, required this.data_chart}) : super(key: key);

  @override
  _pieChartpindad createState() => _pieChartpindad();
...
class _pieChartpindad extends State<pieChartpindad> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          title: const Text("Pie Chart Pindad"),
          leading: IconButton(
