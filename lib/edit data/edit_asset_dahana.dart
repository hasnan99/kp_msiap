...
class EditAsset_dahana extends StatefulWidget {
  final sheet data;
  const EditAsset_dahana({Key? key, required this.data}) : super(key: key);

  @override
  _EditAssetState_dahana createState() => _EditAssetState_dahana();
}

class _EditAssetState_dahana extends State<EditAsset_dahana> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Aset Dahana'),
      ),
      body: SizedBox(
        height: height,
        child: Stack(
  ...
  void _submitForm() async {
    ...
    String url = imageUrl;
    String nama_table="dahana_assets";
