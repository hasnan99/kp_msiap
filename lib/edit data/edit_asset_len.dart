...
class EditAsset extends StatefulWidget {
  final sheet data;
  const EditAsset({Key? key, required this.data}) : super(key: key);

  @override
  _EditAsset createState() => _EditAsset();
}

enum pilihan_upload { uploadFile, googleDriveLink }
class _EditAsset extends State<EditAsset> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Aset LEN'),
      ),
      body: SizedBox(
        height: height,
        child: Stack(
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                Text('Item yang dipilih (Kategori Mesin):'),
                                Wrap(
                                  children: selectedItems_kategori_mesin.map((item) {
                                    return Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              setState(() {
                                                selectedItems_kategori_mesin.remove(item);
                                              });
                                            },
                                          ),
                                        ],
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children:  <Widget>[
                                ...
                                Wrap(
                                  children: selectedItems_raw_material.map((item) {
                                    return Container(
                                      margin: EdgeInsets.all(4),
                                      padding: EdgeInsets.symmetric(horizontal: 8),
                                      decoration: BoxDecoration(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          IconButton(
                                            ...
                                            onPressed: () {
                                              setState(() {
                                                selectedItems_raw_material.remove(item);
                                              });
                                            },
                                          ),
                                        ],
                            ...
                            children: [
                              ...
                              gambar_kartu_mesin || url_gambar_kartu_mesin!.isNotEmpty ? GestureDetector(
                                ...
                                onPressed: () async {
                                  ...
                                  if (file_kartu_mesin == null) {
                                    gambar_kartu_mesin = false;
                                    url_gambar_kartu_mesin = null;
                                  } else {
                                    setState(() {
