...
class EditAsset_pindad extends StatefulWidget {
  ...
  @override
  _EditAsset_pindad createState() => _EditAsset_pindad();
}

enum pilihan_upload { uploadFile, googleDriveLink }
class _EditAsset_pindad extends State<EditAsset_pindad> {
  ...
  Future<http.Response> addgambar(String imagePath, String id, String userEdit) async {
    final url = Uri.parse(sheet_api.URL_addgambar_pindad);
