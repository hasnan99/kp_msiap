...
class EditAsset_pindad extends StatefulWidget {
  final sheet data;
  const EditAsset_pindad({Key? key, required this.data}) : super(key: key);

  @override
  _EditAssetState_pindad createState() => _EditAssetState_pindad();
}

class _EditAssetState_pindad extends State<EditAsset_pindad> {
  ...
  void initState() {
    ...
    nama_asetcontrol=TextEditingController(text: widget.data.nama_aset);
    jenis_asetcontrol=TextEditingController(text: widget.data.jenis_aset);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Edit Aset Pindad'),
      ),
      body: SizedBox(
        height: height,
        child: Stack(
  ...
  void notifikasi() {
    ...
    AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        body: 'User ${user?.email ?? ''} Mengedit data aset menjadi ${nama_asetcontrol.text}',
      ),
    );
  }
}