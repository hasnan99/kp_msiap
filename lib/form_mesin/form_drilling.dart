...
class _form_drilling extends State<form_drilling> {
  ...
  Future<void> fetchDataFromServer() async {
    try {
      ...
      final results = findMatchingData(materialInput, dimensitebalInput,dimensiDiameterInput );
      setState(() {
  ...
  List<String> findMatchingData(String material, String tebal, String diameter) {
    List<String> results = [];
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => GeneratePdf(
                                    ...
                                    tebal: dimensitebalTextController.text,
                                    diameter: dimensiDiameterTextController.text,
                                ),
                              ),
                            );
                          },
...
class GeneratePdf extends StatefulWidget {
  ...
  GeneratePdf({Key? key, required this.hasil, required this.material, required this.tebal, required this.diameter}) : super(key: key);
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Hasil Pencarian Untuk Drilling",style: pw.TextStyle(fontSize: 14,font: font)),
                    pw.Text("Material : ${widget.material}",style: pw.TextStyle(fontSize: 12,font: font)),
                    pw.Text("Dimensi Tebal : ${widget.tebal}",style: pw.TextStyle(fontSize: 12,font: font)),
                    pw.Text("Dimensi Diameter : ${widget.diameter}",style:  pw.TextStyle(fontSize: 12,font: font)),
                    pw.SizedBox(height: 20),
          ...
          children: <Widget>[
            Screenshot(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    const Text("Hasil Pencarian Untuk Drilling",style: TextStyle(fontSize: 20)),
                    const SizedBox(height: 20),
                    Text("Material : ${widget.material}",style: const TextStyle(fontSize: 20)),
                    Text("Dimensi Tebal: ${widget.tebal}",style: const TextStyle(fontSize: 20)),
                    Text("Dimensi Diameter : ${widget.diameter}",style: const TextStyle(fontSize: 20)),
                    const SizedBox(height: 20),
