...
class form_drop_test extends StatefulWidget {
  const form_drop_test({Key? key}) : super(key: key);

  @override
  _form_drop_test createState() => _form_drop_test();
}

class _form_drop_test extends State<form_drop_test> {
  ...
  Future<void> fetchDataFromServer() async {
    try {
      ...
      final ketinggianjatuh = ketinggianjatuhTextController.text;

      final results = findMatchingData(metodeinput, dimensipanjanginput, dimensilebar, dimensitinggi, berat, ketinggianjatuh);
      setState(() {
  ...
  List<String> findMatchingData(String metode,String dimensipanjang,String dimensilebar,String dimensitinggi,String berat,String ketinggianjatuh) {
    List<String> results = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text("Form Drop Test"),
...
class GeneratePdf extends StatefulWidget {
  ...
  GeneratePdf({Key? key, required this.hasil, required this.metode, required this.dimensipanjang, required this.dimensilebar, required this.dimensitinggi, required this.berat, required this.ketinggianjatuh}) : super(key: key);
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Hasil Pencarian Untuk Drop Test",style: pw.TextStyle(fontSize: 20,font: font)),
                    pw.Text("Metode : ${widget.metode}",style:  pw.TextStyle(fontSize: 20,font: font)),
                    pw.Text("Dimensi Panjang: ${widget.dimensipanjang}",style:  pw.TextStyle(fontSize: 20,font: font)),
                    pw.Text("Dimensi Lebar : ${widget.dimensilebar}",style:  pw.TextStyle(fontSize: 20,font: font)),
                    pw.Text("Dimensi Tinggi : ${widget.dimensitinggi}",style:  pw.TextStyle(fontSize: 20,font: font)),
                    pw.Text("Berat : ${widget.berat}",style:  pw.TextStyle(fontSize: 20,font: font)),
                    pw.Text("Ketinggian Jatuh : ${widget.ketinggianjatuh}",style:  pw.TextStyle(fontSize: 20,font: font)),
                    pw.SizedBox(height: 20),
          ...
          children: <Widget>[
            Screenshot(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    const Text("Hasil Pencarian Untuk Drop Test",style: TextStyle(fontSize: 20)),
                    SizedBox(height: 20),
                    Text("Metode : ${widget.metode}",style: TextStyle(fontSize: 20)),
