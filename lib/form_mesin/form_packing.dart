...
class _form_packing extends State<form_packing> {
  ...
  Future<void> fetchDataFromServer() async {
    try {
      ...
      final results = findMatchingData(dimensipanjanginput,dimensilebar,dimensitingginput,beratinput);
      setState(() {
  ...
  List<String> findMatchingData(String dimensipanjang,String dimensilebar,String dimensitinggi,String berat) {
    List<String> results = [];
...
class GeneratePdf extends StatefulWidget {
  ...
  final String berat;
  GeneratePdf({Key? key, required this.hasil, required this.dimensipanjang, required this.dimensilebar, required this.dimensitinggi, required this.berat}) : super(key: key);
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Hasil Pencarian Untuk Packing",style: pw.TextStyle(fontSize: 20,font: font)),
