...
class form_solar_panel extends StatefulWidget {
  const form_solar_panel({Key? key}) : super(key: key);

  @override
  _form_solar_panel createState() => _form_solar_panel();
}

class _form_solar_panel extends State<form_solar_panel> {
  ...
  TextEditingController kapasitasTextController = TextEditingController();
  ...
  Future<void> fetchDataFromServer() async {
    try {
      ...
      final kapasitasinput = kapasitasTextController.text;

      final results = findMatchingData(dimensipanjanginput, dimensilebar, dimensitingginput, kapasitasinput);
      setState(() {
  ...
  List<String> findMatchingData(String dimensipanjang, String dimensilebar, String dimensitinggi, String kapasitas) {
    List<String> results = [];
    ...
    for (var entry in dataFromURLs.entries) {
      ...
      for (var item in data) {
        if (((item['dimensi-kecil-panjang'] == null ? 'null' : item['dimensi-kecil-panjang'].toString()) == dimensipanjang ||
            ...
            ((item['kapasitas_daya-kecil'] == null ? 'null' : item['kapasitas_daya-kecil'].toString()) == kapasitas)||
            ((item['kapasitas_daya-besar'] == null ? 'null' : item['kapasitas_daya-besar'].toString()) == kapasitas)) {
          results.add(key);
          break;
        }
      }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text("Form Solar Panel"),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children:  <Widget>[
                                ...
                                TextFormField(
                                    controller: kapasitasTextController,
                                    keyboardType: TextInputType.number,
                                    decoration: const InputDecoration(
                                        border: InputBorder.none,
                                        fillColor: Color(0xffD6D6D6),
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => GeneratePdf(
                                    ...
                                    kapasitas: kapasitasTextController.text,
                                ),
                              ),
                            );
                          },
...
class GeneratePdf extends StatefulWidget {
  ...
  GeneratePdf({Key? key, required this.hasil, required this.dimensipanjang, required this.dimensilebar, required this.dimensitinggi, required this.kapasitas}) : super(key: key);
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Kapasitas : ${widget.kapasitas}",style: pw.TextStyle(fontSize: 14,font: font)),
                    pw.SizedBox(height: 20),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Kapasitas : ${widget.kapasitas}",style: const TextStyle(fontSize: 20)),
                    SizedBox(height: 20),
