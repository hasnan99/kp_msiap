...
class form_vibration_test extends StatefulWidget {
  const form_vibration_test({Key? key}) : super(key: key);

  @override
  _form_vibration_test createState() => _form_vibration_test();
}

class _form_vibration_test extends State<form_vibration_test> {
  ...
  TextEditingController frekwensiTextController = TextEditingController();
  TextEditingController accelerationTextController = TextEditingController();
  TextEditingController loadTextController = TextEditingController();
  TextEditingController loadkgTextController = TextEditingController();
  ...
  Future<void> fetchDataFromServer() async {
    try {
      ...
      final frekwensiinput = frekwensiTextController.text;
      final accelerationinput = accelerationTextController.text;
      final loadinput = loadTextController.text;
      final loadkginput = loadkgTextController.text;

      final results = findMatchingData(metodeinput, dimensipanjanginput, dimensilebar, dimensitingginput, frekwensiinput, accelerationinput, loadinput, loadkginput);
      setState(() {
  ...
  List<String> findMatchingData(String metode, String dimensipanjang, String dimensilebar, String dimensitinggi, String frekwensi, String acceleration, String load, String loadkg) {
    List<String> results = [];
    ...
    for (var entry in dataFromURLs.entries) {
      ...
      for (var item in data) {
        ...
        item['metode'] == metode &&
            ...
            ((item['frekwensi_kecil'] == null ? 'null' : item['frekwensi_kecil'].toString()) == frekwensi ||
                (item['frekwensi_besar'] == null ? 'null' : item['frekwensi_besar'].toString()) == frekwensi) &&
            ...
            (
                (load == "5g" &&
                    ((item['load-5g-kecil'] == null ? 'null' : item['load-5g-kecil'].toString()) == loadkg ||
                        (item['load-5g-besar'] == null ? 'null' : item['load-5g-besar'].toString()) == loadkg)
                ) ||
                    (load == "10g" &&
                        ((item['load-10g-kecil'] == null ? 'null' : item['load-10g-kecil'].toString()) == loadkg ||
                            (item['load-10g-besar'] == null ? 'null' : item['load-10g-besar'].toString()) == loadkg)
                    ) ||
                    (load == "20g" &&
                        ((item['load-20g-kecil'] == null ? 'null' : item['load-20g-kecil'].toString()) == loadkg ||
                            (item['load-20g-besar'] == null ? 'null' : item['load-20g-besar'].toString()) == loadkg)
                    ) ||
                    (load == "30g" &&
                        ((item['load-30g-kecil'] == null ? 'null' : item['load-30g-kecil'].toString()) == loadkg ||
                            (item['load-30g-besar'] == null ? 'null' : item['load-30g-besar'].toString()) == loadkg)
                    )
            )
        ) {
          results.add(key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text("Form Vibration Test"),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children:  <Widget>[
                                ...
                                TextFormField(
                                    controller: frekwensiTextController,
                                    keyboardType: TextInputType.number,
                                    decoration: const InputDecoration(
                                        border: InputBorder.none,
                                        fillColor: Color(0xffD6D6D6),
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children:  <Widget>[
                                ...
                                DropdownButtonFormField<String>(
                                  value: loadTextController.text==''?null:loadTextController.text,
                                  items: LoadOptions.map((String material) {
                                    return DropdownMenuItem<String>(
                                      value: material,
                                      child: Text(material),
                                    );
                                  ...
                                  onChanged: (String? newValue) {
                                    // Update the selected value
                                    setState(() {
                                      loadTextController.text = newValue ?? '';
                                    });
                                  },
                                  decoration: const InputDecoration(
                                    border: InputBorder.none,
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children:  <Widget>[
                                ...
                                TextFormField(
                                    controller: loadkgTextController,
                                    keyboardType: TextInputType.number,
                                    decoration: const InputDecoration(
                                        border: InputBorder.none,
                                        fillColor: Color(0xffD6D6D6),
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => GeneratePdf(
                                  ...
                                  frekwensi: frekwensiTextController.text,
                                  acceleration: accelerationTextController.text,
                                  load: loadTextController.text,
                                  loadkg: loadkgTextController.text,
                                ),
                              ),
                            );
                          },
...
class GeneratePdf extends StatefulWidget {
  ...
  final String frekwensi;
  final String acceleration;
  final String load;
  final String loadkg;
  GeneratePdf({Key? key, required this.hasil, required this.dimensipanjang, required this.dimensilebar, required this.dimensitinggi, required this.metode, required this.frekwensi, required this.acceleration, required this.load, required this.loadkg,}) : super(key: key);
              ...
              children: [
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Frekwensi : ${widget.frekwensi}",style: pw.TextStyle(fontSize: 14,font: font)),
                    pw.Text("Acceleration : ${widget.acceleration}",style: pw.TextStyle(fontSize: 14,font: font)),
                    pw.Text("Load : ${widget.load}",style: pw.TextStyle(fontSize: 14,font: font)),
                    pw.Text("Load(kg) : ${widget.loadkg}",style: pw.TextStyle(fontSize: 14,font: font)),
                    pw.SizedBox(height: 20),
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text("Frekwensi : ${widget.frekwensi}",style: const TextStyle(fontSize: 20)),
                    Text("Acceleration : ${widget.acceleration}",style: const TextStyle(fontSize: 20)),
                    Text("Load : ${widget.load}",style: const TextStyle(fontSize: 20)),
                    Text("Load(kg) : ${widget.loadkg}",style: const TextStyle(fontSize: 20)),
                    SizedBox(height: 20),
