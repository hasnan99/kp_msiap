...
class mesin_dahana extends StatefulWidget {
  const mesin_dahana({Key? key}) : super(key: key);

  @override
  _mesin_dahana createState() => _mesin_dahana();
}

class _mesin_dahana extends State<mesin_dahana> {
  List<Mesin>data = [];
  ...
  Future generatedata() async {
    try{
      final response = await http.get(Uri.parse(sheet_api.URL_mesin_dahana));
