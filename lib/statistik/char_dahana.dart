...
class ChartPageDahana extends StatefulWidget {
  ChartPageDahana({Key? key}) : super(key: key);

  @override
  _ChartPageDahana createState() => _ChartPageDahana();
...
class _ChartPageDahana extends State<ChartPageDahana> {
  ...
  Future<List<sheet_chart>> _fetchDatadahana() async {
    try {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Statistik Asset Dahana"),
        actions: [
          IconButton(
            icon: Icon(Icons.pie_chart),
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => ChartPieDahana()));
            },
          ),
        ],
      ),
