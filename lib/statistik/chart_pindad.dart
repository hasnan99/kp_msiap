...
import 'package:kp_msiap/statistik/chart_pie_pindad.dart';
import 'package:syncfusion_flutter_charts/charts.dart';

class ChartPagePindad extends StatefulWidget {
  ChartPagePindad({Key? key}) : super(key: key);

  @override
  _ChartPagePindad createState() => _ChartPagePindad();
...
class _ChartPagePindad extends State<ChartPagePindad> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Statistik assets Pindad"),
        actions: [
          IconButton(
            icon: Icon(Icons.pie_chart),
            onPressed: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => ChartPiepindad()));
            },
          ),
        ],
      ),
