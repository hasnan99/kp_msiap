...
class AddData_dahana extends StatefulWidget {
  const AddData_dahana({Key? key}) : super(key: key);

  @override
  _AddData_dahana createState() => _AddData_dahana();
}

enum pilihan_upload { uploadFile, googleDriveLink }
class _AddData_dahana extends State<AddData_dahana> {
  ...
  void _submitForm() async {
    ...
    if (linkdrive == true) {
      ...
      data_sheet = selected_data_Sheet ?? "Na";
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      key: _scaffoldKey,
      appBar: AppBar(
        title: const Text("Tambah data Dahana"),
  ...
  Future<http.Response> addgambar(String imagePath, String id, String userEdit) async {
    final url = Uri.parse(sheet_api.URL_addgambar_dahana);
