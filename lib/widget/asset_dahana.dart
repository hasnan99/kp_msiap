...
class AssetDahana extends StatefulWidget {
  ...
  final String query;
  AssetDahana({Key? key, required this.query,}) : super(key: key);

  @override
  _AssetDahana createState() => _AssetDahana();

  static void refreshData(BuildContext context) {
    final state = _AssetDahana.of(context);
    state.refreshData();
  }
}

class _AssetDahana extends State<AssetDahana> {
  List<sheet>data = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () async {
          Navigator.of(context).pushReplacement(new MaterialPageRoute(builder: (context) => EditAsset_dahana(data: widget.data))).
