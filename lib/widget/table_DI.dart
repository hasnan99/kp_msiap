          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                bool cleardata= await Navigator.push(context,
                    MaterialPageRoute(builder: (context)=>barChartDI(data_chart: cellValues,)));
                if(cleardata==true){
                  cellValues.clear();
                }
              },
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                bool cleardata= await Navigator.push(context,
                    MaterialPageRoute(builder: (context)=>pieChartDI(data_chart: cellValues,)));
                if(cleardata==true){
                  cellValues.clear();
                }
              },
